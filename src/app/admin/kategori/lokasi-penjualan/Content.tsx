...
const halaman = "Kategori Lokasi Penjualan";
...
const Content = () => {
  ...
  // store
  const { removeData } = useKategoriLokasiPenjualan();
  // state
  const [idDel, setIdDel] = useState<number | string>();
  const [dtEdit, setDtEdit] = useState<any>();

  const handleTambah = () => {
    showModal("add_kategoriLokasiPenjualan");
    setDtEdit(null);
  };
      ...
      <div>
        ...
        <div className="mb-4 flex justify-between">
          <p>
            ...
            menambahkan kategori Lokasi Penjualan.
          </p>
